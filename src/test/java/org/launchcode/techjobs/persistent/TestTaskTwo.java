...
public class TestTaskTwo extends AbstractTest {
   ...
   @Test
    public void testEmployerRepositoryDefinition () throws ClassNotFoundException {
        ...
        assertEquals(EmployerRepository.class, employerRepositoryField.getType(), "employerRepository must be of type EmployerRepository");assertNotNull(employerRepositoryField.getAnnotation(Autowired.class), "employerRepository must have the @Autowired annotation");
    }
